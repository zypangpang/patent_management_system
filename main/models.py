...
class Patent(models.Model):
    ...
    law_state=models.CharField(max_length=80,default='')

    cat_id=models.CharField(max_length=60,blank=True)
    branch1=models.CharField(max_length=80,blank=True)
    branch2=models.CharField(max_length=80,blank=True)
    branch3=models.CharField(max_length=80,blank=True)
